...
3. Класс "Книга" (`Book2`) из первого задания;
4. Свяжите между собой классы `Author` и `Book2`, чтобы среди типов полей одних классов встречались другие.

### Пример реализации
1. Создайте новый проект в repl.it.
3. Создайте класс `Author`.
4. Создайте класс `Book2`.
